...
CHEF_SERVER_NAME="Chef-automate-demo" # The name of your Chef Server
CHEF_SERVER_ENDPOINT="chef-automate-demo-n7kqag9cttxs8bzi.us-west-2.opsworks-cm.io" # The FQDN of your Chef Server
